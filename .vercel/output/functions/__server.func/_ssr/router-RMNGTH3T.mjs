...
const appCss = "/assets/styles-C5Bnyss8.css";
...
const Route = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "4 semaines de formation intensive aux métiers du numérique. Web, IA, Design, Hackathon. Inscription : 5 000 FCFA."
    }, {
      property: "og:title",
      content: "Bootcamp Amphix 2026"
    }, {
      property: "og:description",
      content: "4 semaines pour transformer vos idées en projets concrets. Inscription : 5 000 FCFA."
    }, {
      property: "og:image",
      content: heroImg
    }, {
